...
def main():
    ...
    with home:
        ...
        st.write(
            ...
            3) Complete example task with timing and outcome recording.
    ...
    with demographics:
        ...
        with st.form("demographic_form"):
            ...
            with col1:
                ...
                gender = st.selectbox("Gender (optional)", ["Prefer not to say", "Female", "Male"])
            with col2:
